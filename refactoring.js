...
// if there is a password error, e.g. if password !== blank
...
function getPasswordError(passwordInput) {
   ...
   // return `Your password must be at leaszt 9 characters.`
   ...
   // return `Your password contains a commonly used password, "123456", and can be easily discovered by
   // attackers. Please use something else.`
   // else return `` // an empty string
}
...
// getPasswordError.js
// getEmailError.js
// password lists (all three of them)
